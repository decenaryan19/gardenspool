...
export const Route = createFileRoute("/category/$category")({
  ...
  head: ({ loaderData }) => {
    ...
    const url = `/category/${loaderData.category}/`;
    return {
      meta: [
        { title },
      ...
      links: [{ rel: "canonical", href: `/${loaderData.category}/` }],
    };
  },
      ...
      <section className="relative overflow-hidden bg-hero-gradient">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:py-24">
          ...
          <p className="mt-5 max-w-2xl text-lg text-white/85">
            Articles in the {label} category from Gardens Pool Service in Palm Beach Gardens, FL.
          </p>
          <div className="mt-8">
        ...
        {posts.length === 0 ? (
          ...
          <div className="grid gap-5 md:grid-cols-2">
            {posts.map((p: typeof posts[number]) => (
              ...
              >
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-primary-deep">{label}</p>
